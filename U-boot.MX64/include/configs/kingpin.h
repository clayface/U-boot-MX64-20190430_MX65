...
#ifdef CONFIG_L2C_AS_RAM
#define CONFIG_ENV_SIZE			0x40000 /* 4K */
#else
#define CONFIG_ENV_SIZE			0x40000 /* 64K */
#endif /* CONFIG_L2C_AS_RAM */
/* NO flash */
...
#define CONFIG_BOOTCOMMAND 	"mx65init; run ubi_checkboot; run usb_checkboot; run meraki_checkboot"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	"ubi_boot=ubi part ubi && ubi read ${loadaddr} kernel && bootm ${loadaddr}#${config_dts}\0" \
        ...
        "initramfs_filename=openwrt-bcm53xx-generic-meraki_mx65-initramfs.bin\0" \
